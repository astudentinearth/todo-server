...
export function TodoList(){
    ...
    return <div className="sm:flex-grow-0 justify-center p-4 pt-2 gap-2 flex flex-col flex-grow z-0 w-full sm:w-[640px]">
        <TextInput inputRef={inputRef} onKeyDown={inputKeyDown} placeholder="New todo" className="outline-none flex text-body p-3 rounded-md w-full sm:w-[608px]"></TextInput> 
        {
