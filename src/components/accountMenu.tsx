...
export default function AccountMenu(){
    ...
    return <div className="">
        ...
        <div ref={visibility.ref} style={visibility.isComponentVisible ? {opacity: 1, visibility:"visible"} : {opacity: 0, visibility:"hidden"}} className="fixed transition-[opacity,visibility] p-2 backdrop-blur-md menu rounded-2xl bg-modal-3/75 w-72 right-2 top-20">
            ...
            <div onClick={async ()=>{await logout()}} className="z-10 account-menu-button rounded-lg hover:bg-danger active:brightness-125 transition-[filter,background]">
